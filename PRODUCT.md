...
- Canonical header/footer markup is duplicated across all 15 pages by design (no templating) — changes must be applied to every page.
...
- Photography: 20 plates in `assets/img/photos/` (WebP served, JPG masters kept), hero video `hero-towers-720.mp4`, Mahatrax brochure PDF and SVG hero art.
